...
=head2 How do I find the modules of a particular author?
...
<<<<<<< HEAD
save files as "Text Only". You can also download Notepad++ which is a
free source code editor - L<http://notepad-plus.sourceforge.net/>.
=======
save files as "Text Only".
>>>>>>> 44ca10db051c999a204997266dde73da4e2ef904
